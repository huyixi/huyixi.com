...
const components = {
  ...
  h2: (props: HeadingProps) => (
    <h2 className="text-xl md:text-xl mb-2 mt-12 font-medium" {...props} />
  ),
  ...
  p: (props: ParagraphProps) => <p className="text-copy my-5" {...props} />,
  ol: (props: ListProps) => (
    <ol
  ...
  ul: (props: ListProps) => (
    <ul className="text-copy pl-0 space-y-1" {...props} />
  ),
  li: ({ children, ...props }: ListItemProps) => (
    <li
      className="relative pl-3 before:content-['▪'] before:absolute before:left-0 before:text-foreground/60"
      {...props}
    >
      {children}
    </li>
